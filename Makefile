...
usage:
	...
	@echo "  test[-c]-3X     run core tests with Python 3.X (10<=X<=13) [and C extension modules]"
	...
	@echo "  test[-c]-3X-all run core and disassembly tests with Python 3.X (10<=X<=13) [and C extension modules]"
