...
class HtmlWriter:
    ...
    def expand_audio(self, text, index, cwd):
        end, interrupts, contention, offset, ma_filter, beeper, fname, delays, audio_log = skoolmacro.parse_audio(self, text, index, self._need_audio)
