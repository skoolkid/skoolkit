...
def parse_udgs(writer, text, index, *cwd):
    ...
    names = ('width', 'height', 'scale', 'flip', 'rotate', 'mask')
    defaults = (None, 0, 0, None)
    end, width, height, scale, flip, rotate, mask = parse_ints(text, index, 0, defaults, names, writer.fields)
