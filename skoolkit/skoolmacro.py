...
def parse_audio(writer, text, index, need_audio=None):
    ...
    names = ('sim', 'start', 'stop', 'execint', 'cmio', 'offset', 'ay', 'bpr', 'vol')
    defaults = (None, None, 0, 0, None, 0, 0, 100)
    end, sim, start, stop, execint, cmio, offset, ay, bpr, vol = parse_ints(text, index, len(names), defaults, names, writer.fields)
    ...
    return end, execint, cmio, offset or 0, bpr, vol, fname, delays, audio_log
