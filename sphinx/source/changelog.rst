...
* Added the ``tindex`` parameter to the :ref:`FONT` macro (for specifying a
  transparent colour to use other than the default)
* Added the ``alpha`` parameter to the :ref:`FONT` macro (for specifying the
  alpha value to use for the transparent colour)
