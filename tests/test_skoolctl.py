...
class CtlWriterTest(SkoolKitTestCase):
    ...
    def test_arithmetic_expressions(self):
        skool = """
            b40000 DEFB 32768/256,32768%256,1+2,3*4,5-6,"A"+"B"
             40006 DEFM 32768/256,32768%256,1+2,3*4,5-6,"A"+"B"
             40012 DEFS 256*2,128/2
             40524 DEFS "A"*4,"z"+38
        """
        exp_ctl = """
            b 40000
    ...
    def test_expand_directives(self):
        skool = """
            ...
            ; Routine
            c32768 LD A,B
            @expand=#DEFINE0(C,#CHR(169))
             32769 RET
        """
        exp_ctl = """
            @ 32768 expand=#LET(a=1)
            c 32768 Routine
            @ 32769 expand=#DEFINE0(C,#CHR(169))
            i 32770
        """
        self._test_ctl(skool, exp_ctl)
