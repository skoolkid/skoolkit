...
class CommonSkoolMacroTest:
    ...
    def test_macro_copy_invalid(self):
        ...
        self._test_invalid_image_macro(writer, '#COPY1//f//', "Not enough parameters (expected 2): 'f'", prefix)
        self._test_invalid_image_macro(writer, '#COPY1,2,3,4,5,6,7,8(f)', "No terminating delimiter: ,8(f)", prefix)
        self._test_invalid_image_macro(writer, '#COPY(1,2,3,4,5,6,7,8)(f)', "Too many parameters (expected 7): '1,2,3,4,5,6,7,8'", prefix)
