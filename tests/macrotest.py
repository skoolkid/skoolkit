...
class CommonSkoolMacroTest:
    ...
    def test_macro_copy_invalid(self):
        ...
        self._test_invalid_image_macro(writer, '#COPY1,2,3,4,5,6(f)', "Too many parameters (expected 5): '1,2,3,4,5,6'", prefix)
        self._test_invalid_image_macro(writer, '#COPY(1,2,3,4,5,6)(f)', "Too many parameters (expected 5): '1,2,3,4,5,6'", prefix)
