...
INSTRUCTIONS = {
    ...
    'EDA0': "POKE #REGde,PEEK #REGhl; #REGhl+=1; #REGde+=1; #REGbc-=1",
    'EDA1': "Compare #REGa with PEEK #REGhl; #REGhl+=1; #REGbc-=1",
    'EDA2': "POKE #REGhl,IN #REGbc; #REGhl+=1; #REGb-=1",
    'EDA3': "#REGb-=1; OUT #REGbc,PEEK #REGhl; #REGhl+=1",
    'EDA8': "POKE #REGde,PEEK #REGhl; #REGhl-=1; #REGde-=1; #REGbc-=1",
    'EDA9': "Compare #REGa with PEEK #REGhl; #REGhl-=1; #REGbc-=1",
    'EDAA': "POKE #REGhl,IN #REGbc; #REGhl-=1; #REGb-=1",
    'EDAB': "#REGb-=1; OUT #REGbc,PEEK #REGhl; #REGhl-=1",
    'EDB0': "POKE #REGde,PEEK #REGhl; #REGhl+=1; #REGde+=1; #REGbc-=1; repeat until #REGbc=0",
    'EDB1': "Compare #REGa with PEEK #REGhl; #REGhl+=1; #REGbc-=1; repeat until #REGbc=0 or #REGa=PEEK #REGhl",
    'EDB2': "POKE #REGhl,IN #REGbc; #REGhl+=1; #REGb-=1; repeat until #REGb=0",
    'EDB3': "#REGb-=1; OUT #REGbc,PEEK #REGhl; #REGhl+=1; repeat until #REGb=0",
    'EDB8': "POKE #REGde,PEEK #REGhl; #REGhl-=1; #REGde-=1; #REGbc-=1; repeat until #REGbc=0",
    'EDB9': "Compare #REGa with PEEK #REGhl; #REGhl-=1; #REGbc-=1; repeat until #REGbc=0 or #REGa=PEEK #REGhl",
    'EDBA': "POKE #REGhl,IN #REGbc; #REGhl-=1; #REGb-=1; repeat until #REGb=0",
    'EDBB': "#REGb-=1; OUT #REGbc,PEEK #REGhl; #REGhl-=1; repeat until #REGb=0",
}
...
AFTER_DD = {
    ...
    'DD84': "#REGa+=#REGixh",
    'DD85': "#REGa+=#REGixl",
    'DD86FF': f"#REGa+=PEEK {IX_FF}",
    'DD8C': "#REGa+=carry+#REGixh",
    'DD8D': "#REGa+=carry+#REGixl",
    'DD8EFF': f"#REGa+=carry+PEEK {IX_FF}",
    'DD94': "#REGa-=#REGixh",
    'DD95': "#REGa-=#REGixl",
    'DD96FF': f"#REGa-=PEEK {IX_FF}",
    'DD9C': "#REGa-=carry+#REGixh",
    'DD9D': "#REGa-=carry+#REGixl",
    'DD9EFF': f"#REGa-=carry+PEEK {IX_FF}",
    'DDA4': "#REGa&=#REGixh",
    'DDA5': "#REGa&=#REGixl",
    'DDA6FF': f"#REGa&=PEEK {IX_FF}",
    'DDAC': "#REGa^=#REGixh",
    'DDAD': "#REGa^=#REGixl",
    'DDAEFF': f"#REGa^=PEEK {IX_FF}",
    'DDB4': "#REGa|=#REGixh",
    'DDB5': "#REGa|=#REGixl",
    'DDB6FF': f"#REGa|=PEEK {IX_FF}",
