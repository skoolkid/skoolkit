...
class SkoolMacroTest(HtmlWriterTestCase):
    ...
    def test_macro_for(self):
        ...
        for delim1 in '[{/|':
            ...
            output = writer.expand('1; #FOR4,10,3{}@n,@n; {}13'.format(delim1, delim2), ASMDIR)
    ...
    def test_macro_for_with_separator(self):
        ...
        output = writer.expand('{ #FOR1,5(n,n, | ) }', ASMDIR)
        self.assertEqual(output, '{ 1 | 2 | 3 | 4 | 5 }')

        output = writer.expand('#FOR6,10//n/(n)/, //', ASMDIR)
    ...
    def test_macro_map(self):
        ...
        output = writer.expand('#MAP1()', ASMDIR)
        self.assertEqual(output, '')
