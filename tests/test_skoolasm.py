...
class AsmWriterTest(SkoolKitTestCase, CommonSkoolMacroTest):
    ...
    def test_macro_include(self):
        ...
        self.assertEqual(writer.expand('#INCLUDE({p})(blah)'), '')
    ...
    def test_macro_over(self):
        ...
        self._test_unsupported_macro(writer, '#OVER(1,1,1,1,3)(1)(2)(b,f)')
        self._test_unsupported_macro(writer, '#OVER({x},{y},rmode={rmode})(b,f)')
    ...
    def test_macro_scr(self):
        ...
        self._test_unsupported_macro(writer, '#SCR({s}){{x}}')
    ...
    def test_macro_udgs(self):
        ...
        self._test_unsupported_macro(writer, '#UDGS2,2,1,1,1,2,1,0(item)(#UDG($x+$y)(*f) f)')
