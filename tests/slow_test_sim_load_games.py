...
class SimLoadGamesTest(SkoolKitTestCase):
    ...
    def test_alternative(self):
        self._test_sim_load(
            ...
            '8ea055a1f78379cca67c65cdd1efce96',
            {
    ...
    def test_alternative2(self):
        self._test_sim_load(
            ...
            'ee34d8c9d33a22a643263c574ac3c879',
            {
    ...
    def test_crl(self):
        self._test_sim_load(
            ...
            '0803346fe3af7b11cce18d89b6775a59',
            {
    ...
    def test_crl2(self):
        self._test_sim_load(
            ...
            '036705b82022048769233de40a44ef38',
            {
    ...
    def test_crl3(self):
        self._test_sim_load(
            ...
            'dee8037bcaf611c0dfb197bf5cc57835',
            {
    ...
    def test_crl4(self):
        self._test_sim_load(
            ...
            '2fc01c8fc85b2d411d1d1411aa17ef13',
            {
    ...
    def test_d_and_h(self):
        self._test_sim_load(
            ...
            'dd711e1c1513580185c0b270ab5aa17a',
            {
    ...
    def test_design_design(self):
        self._test_sim_load(
            ...
            '52d1684bd5dee840d21b64d89bd84908',
            {
    ...
    def test_gremlin2(self):
        self._test_sim_load(
            ...
            'e8d745af94efd22fefc0f47c04075288',
            {
    ...
    def test_microprose(self):
        self._test_sim_load(
            ...
            '5b0007ebb7110d5463420b7f95e53cc1',
            {
    ...
    def test_micro_style(self):
        self._test_sim_load(
            ...
            '8ab87d9b2ea6375d5da696802e5ff6b2',
            {
    ...
    def test_realtime(self):
        self._test_sim_load(
            ...
            '3e26307a6e09789f106846b30e1d0b43',
            {
    ...
    def test_silverbird(self):
        self._test_sim_load(
            ...
            '30572b5fdfa08dea33ad1cd91bd46ef6',
            {
    ...
    def test_sparklers(self):
        self._test_sim_load(
            ...
            '790bbd076151309aac4151e10354a9de',
            {
    ...
    def test_suzy_soft2(self):
        self._test_sim_load(
            ...
            '1c73ccc1073c0b3c7162dbf077ee4935',
            {
    ...
    def test_tiny(self):
        self._test_sim_load(
            ...
            '25461848f0ae0b85b136a50131d1231a',
            {
    ...
    def test_weird_science(self):
        self._test_sim_load(
            ...
            'a0d396469b113440d9cbefbe62d4cb63',
            {
