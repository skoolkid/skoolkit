...
class SimLoadGamesTest(SkoolKitTestCase):
    ...
    def test_alkatraz(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0044,06FF,0000,2E2E',
    ...
    def test_alternative(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,B05D,0000,0017',
                "AF',BC',DE',HL'": '5D4D,1621,369B,2758',
                'PC,SP,IX,IY': 'FCD3,FFFF,FBFF,0000',
                'IR,iff,im,border': '3F30,0,1,0',
                'ram': '8ea055a1f78379cca67c65cdd1efce96'
            },
    ...
    def test_alternative2(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,B05D,0000,008F',
                "AF',BC',DE',HL'": '5D4D,1621,369B,2758',
                'PC,SP,IX,IY': 'FB8C,FFFF,E800,5C3A',
                'IR,iff,im,border': '3F5E,0,1,0',
                'ram': 'ee34d8c9d33a22a643263c574ac3c879'
            },
    ...
    def test_basil_the_great_mouse_detective(self):
        ...
        self._test_sim_load(
            ...
            '-c first-edge=0 -c accelerator=none --start 55822'
        )
    ...
    def test_boguslaw_juza(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,B07E,0000,0050',
                "AF',BC',DE',HL'": '7E6D,0614,FF38,2758',
    ...
    def test_contended_in(self):
        ...
        self._test_sim_load(
            ...
            'e8f2e39a382c56c82318e1a92dd69274',
            {
                ...
                'ram': '038cabb1ffe56e8e9793e39b9808a597'
            },
    ...
    def test_crl(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,B040,0000,00C8',
                "AF',BC',DE',HL'": '4044,0B21,369B,2758',
                'PC,SP,IX,IY': 'FE76,0000,F4C3,5C3A',
                'IR,iff,im,border': '3F24,0,1,0',
                'ram': '0803346fe3af7b11cce18d89b6775a59'
            },
    ...
    def test_crl3(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,B05F,0000,00CB',
                "AF',BC',DE',HL'": '5F4D,0100,48B6,59B5',
                'PC,SP,IX,IY': '8045,0000,B537,5C3A',
                'IR,iff,im,border': '3F2C,0,1,0',
                'ram': 'dee8037bcaf611c0dfb197bf5cc57835'
            },
    ...
    def test_crl4(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,B020,0000,0097',
                "AF',BC',DE',HL'": '2065,0721,369B,2758',
                'PC,SP,IX,IY': '5B3E,5DA8,0000,5C3A',
                'IR,iff,im,border': '3F64,1,1,0',
                'ram': '2fc01c8fc85b2d411d1d1411aa17ef13'
            },
    ...
    def test_cybexlab(self):
        self._test_sim_load(
            ...
            '251a73d47759918ee9223d9042558064',
            {
                ...
                'IR,iff,im,border': '3F21,0,1,7',
                'ram': 'b79eec51bd81d53827524a910e52d6b0'
            },
    ...
    def test_d_and_h(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,C427,0000,0039',
                "AF',BC',DE',HL'": '2765,1621,369B,2758',
                'PC,SP,IX,IY': 'FE0E,0000,FDFD,5C3A',
                'IR,iff,im,border': '3FDC,0,1,0',
                'ram': 'dd711e1c1513580185c0b270ab5aa17a'
            },
    ...
    def test_design_design(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0044,B001,0020,5B00',
                "AF',BC',DE',HL'": '0044,1621,369B,2758',
                'PC,SP,IX,IY': '5B00,FFFE,A000,0000',
                'IR,iff,im,border': '3F5F,0,1,1',
                'ram': '52d1684bd5dee840d21b64d89bd84908'
            },
    ...
    def test_digital_integration(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0044,DE4E,4C00,F986',
    ...
    def test_dinaload(self):
        self._test_sim_load(
            ...
            '18afd7805b83ebc4974ccd8637d8a7b3',
            {
                ...
                'IR,iff,im,border': '3F38,0,1,1',
                'ram': 'e361a4d0cef9278f347b8268a709ec02'
            },
    ...
    def test_gremlin(self):
        self._test_sim_load(
            ...
            '48cdfc186f94bf6382da93cbc4b70810',
            {
                ...
                'ram': '3c16b10bfcce8973687153b3fe4c2953'
            },
    ...
    def test_gremlin2(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,B0BE,0000,CCEE',
                "AF',BC',DE',HL'": 'FF45,1621,369B,2758',
                'PC,SP,IX,IY': 'A0EB,FFFA,CCEE,5C3A',
                'IR,iff,im,border': '3FDD,0,1,6',
    ...
    def test_microprose(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0050,0021,0000,AE01',
    ...
    def test_micro_style(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0044,BCF8,8900,0000',
                "AF',BC',DE',HL'": 'FF45,1621,369B,2758',
    ...
    def test_out_of_the_shadows(self):
        ...
        self._test_sim_load(
            ...
            '40f664f094ea41868793bffa59ebae95',
            {
                ...
                'IR,iff,im,border': '3F4C,1,1,3',
                'ram': '034b7b141d4046430ac89894d1fac6ba'
            },
            '--start 36880'
        )
    ...
    def test_raxoft(self):
        self._test_sim_load(
            ...
            '21cb4ea8ce5dbdfc2b5ef039e4ed6c77',
            {
                ...
                'ram': 'e30760b474ff30dd93dcc5928a46826c'
            },
    ...
    def test_realtime(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,B07F,0000,0025',
    ...
    def test_search_loader(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0202,B000,0000,0006',
    ...
    def test_silverbird(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0054,B03E,0000,002E',
                "AF',BC',DE',HL'": '0044,1621,369B,2758',
    ...
    def test_sparklers(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,C401,0000,00F4',
                "AF',BC',DE',HL'": '0144,C9AC,369B,0000',
                'PC,SP,IX,IY': 'FE99,6393,E54C,3E00',
                'IR,iff,im,border': '3F69,0,1,1',
                'ram': '790bbd076151309aac4151e10354a9de'
            },
    ...
    def test_square_head(self):
        ...
        self._test_sim_load(
            ...
            '04b1b63a321dd817a67bafe4b85ce41b',
            {
                ...
                'IR,iff,im,border': '3F10,1,1,0',
                'ram': 'f98298fd7e643737b94bf103a00ecb63'
            },
            '--start 24528'
        )
    ...
    def test_standard_load(self):
        self._test_sim_load(
            ...
            '2750ccb6c240d14516c448e94f8d200e',
            {
                ...
                'IR,iff,im,border': '3F22,1,1,0',
                'ram': 'c0a196c2acccb5b03113b18e596fa575'
            },
        )
    ...
    def test_suzy_soft2(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0150,00DD,019D,FF01',
    ...
    def test_tiny(self):
        self._test_sim_load(
            ...
            '679e385bfaac090402c589c23ca12095',
            {
                ...
                "AF',BC',DE',HL'": '4445,8A97,369B,5A9E',
    ...
    def test_weird_science(self):
        self._test_sim_load(
            ...
            {
                'AF,BC,DE,HL': '0093,B0BA,0000,0021',
